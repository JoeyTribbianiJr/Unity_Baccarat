...
namespace WsBaccarat
{
	...
	public class Setting
	{
		...
		private Setting()
		{
			...
			game_int_setting.Add("round_num_per_session", new SettingIntItem() { desc = "一局场数", value = 66, values = new int[] { 30, 45, 66 } });
			...
			//game_int_setting.Add("shuffle_tm", new SettingIntItem() { desc = "洗牌时间", value = 120, values = new int[] { 30, 60 } });
